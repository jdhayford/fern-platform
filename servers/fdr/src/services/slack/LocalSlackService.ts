import { FailedToDeleteIndexSegment, FailedToRegisterDocsNotification, FailedToRevalidatePathsNotification, GeneratingDocsNotification, SlackService } from "./SlackService";

export class LocalSlackService implements SlackService {
